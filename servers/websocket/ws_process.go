...
func ProcessData(client *Client, message []byte) {
	...
	//global.WL_Log.Info("处理数据:"+grpcclient.Addr, zap.String("message", string(message)))
	...
	// request
	//global.WL_Log.Info("warlock_request", zap.String("request", event+" "+grpcclient.Addr))
	...
	responseHead := ws.NewResponseHead(seq, event, code, msg, data)
	...
	//fmt.Println("warlock_response send", grpcclient.Addr, grpcclient.AppId, grpcclient.UserId, "event", event, "code", code)
